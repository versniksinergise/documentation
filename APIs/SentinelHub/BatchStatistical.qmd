...
If you do not yet have a bucket at Copernicus Data Space Ecosystem, please follow [these steps](TODO link) to get one.

You will have to configure your bucket to allow full access to Sentinel Hub. To do
this, [update your bucket policy](TODO link) to include the following statement (don't forget to replace `<bucket_name>` with your actual bucket name):
...
In your Batch Statistical API request you will have to provide you `accessKey` and `secretAccessKey` pair
in your batch statistical request:
