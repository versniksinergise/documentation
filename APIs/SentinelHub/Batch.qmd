...
**Batch Processing API is only available for enterprise users. If you
don\'t have an enterprise account, and would like to try it out,
...
object storage, which needs to be specified in the request (e.g. S3
bucket, see [AWS S3 bucket settings](#aws-bucket-settings) below). The
...
request. For example: ![](Batch/img/batch-sub-folders.png)
