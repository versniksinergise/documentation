...
-   Evalscript can be either sent directly in the request or it can be
    ...
    paratmeter evalscriptReference in Async API reference for more
...
-   read evalscript from an bucket (this is optional because an
    evalscript can also be provided directly in a request),
-   write results of processing to an bucket.
...
Async request has been created, we will deliver a \"error.json\" file
